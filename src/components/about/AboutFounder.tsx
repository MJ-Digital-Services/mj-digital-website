      ...
      <div className="about-founder-inner">
        ...
        <div className="about-founder-content">
          ...
          <div className="about-founder-meta">
            ...
            <div className="about-founder-role">Founder &amp; CEO, MJ Digital Services</div>
            <div className="about-founder-socials">
              ...
              <a href="mailto:business@mjdigitalservices.com" aria-label="Email" className="about-founder-social">
                <Mail size={16} />
              </a>
            </div>
          </div>
